const se = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1: 'För att återställa lösenordet, håll in BOOT-knappen på CEC KVM i 10 sekunder.',
        ...
        change4: 'För att återställa lösenordet, håll in BOOT-knappen på CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Konfigurera Wi-Fi för CEC KVM',
      success: 'Kontrollera nätverksstatusen för CEC KVM och besök den nya IP-adressen.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Om din mus och ditt tangentbord slutar svara och återställning av HID inte hjälper, kan det bero på kompatibilitetsproblem mellan CEC KVM och enheten. Prova att aktivera Endast-HID-läge för bättre kompatibilitet.',
        ...
        tip3: 'CEC KVM kommer automatiskt att starta om efter lägesbyte',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Anslut CEC KVM till din dator via USB.',
        ...
        scp1: 'Säkerställ att CEC KVM och din dator är på samma lokala nätverk.',
        scp2: 'Öppna en terminal på din dator och använd SCP-kommandot för att ladda upp avbildningen till /data på CEC KVM.',
        scp3: 'Exempel: scp din-avbildningssökväg root@din-nanokvm-ip:/data',
        tfCard: 'TF-kort',
        tf1: 'Denna metod stöds på Linux-system',
        tf2: 'Ta ut TF-kortet från CEC KVM (för FULL-versionen, öppna chassit först).',
        tf3: 'Sätt in TF-kortet i en kortläsare och anslut till din dator.',
        tf4: 'Kopiera avbildningsfilen till /data på TF-kortet.',
        tf5: 'Sätt in TF-kortet i CEC KVM.'
      }
    },
    script: {
      title: 'Skript',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'CEC KVM webbapplikationsversion',
        image: 'Systemversion',
        imageTip: 'CEC KVM systemavbildningsversion',
      ...
      device: {
        ...
        reboot: 'Starta om',
        rebootDesc: 'Är du säker på att du vill starta om CEC KVM?',
        okBtn: 'Ja',
        cancelBtn: 'Nej'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Konfigurera DNS-servrar för CEC KVM',
          mode: 'Läge',
          dhcp: 'DHCP',
          manual: 'Manuell',
          add: 'Lägg till DNS',
      ...
      tailscale: {
        ...
        upTailscale: 'Ladda upp tailscale till CEC KVM-katalogen /usr/bin/',
        upTailscaled: 'Ladda upp tailscaled till CEC KVM-katalogen /usr/sbin/',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Manövrera fjärrvärden genom CEC KVM.',
