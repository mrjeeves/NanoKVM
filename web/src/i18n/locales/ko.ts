const ko = {
  translation: {
    ...
    auth: {
      ...
      loginButtonText: '로그인',
      tips: {
        reset1: '비밀번호를 재설정하려면 CEC KVM의 BOOT 버튼을 10초 동안 누르고 계세요.',
        ...
        change4: '비밀번호를 재설정하려면 CEC KVM의 BOOT 버튼을 길게 누르세요.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'CEC KVM Wi-Fi 설정',
      success: 'CEC KVM의 네트워크 상태를 확인하고 새 IP 주소로 접속하세요.',
    ...
    mouse: {
      ...
      hidOnly: {
        title: 'HID 전용 모드',
        desc: '마우스와 키보드가 응답하지 않고 HID 초기화도 도움이 되지 않는다면, CEC KVM과 장치 간의 호환성 문제일 수 있습니다. 더 나은 호환성을 위해 HID 전용 모드를 활성화해 보세요.',
        tip1: 'HID 전용 모드를 활성화하면 가상 USB와 가상 네트워크가 언마운트됩니다',
        tip2: 'HID 전용 모드에서는 이미지 마운트가 비활성화됩니다',
        tip3: '모드 전환 후 CEC KVM이 자동으로 재부팅됩니다',
    ...
    image: {
      ...
      tips: {
        title: '업로드 방법',
        usb1: 'USB를 통해 CEC KVM을 컴퓨터에 연결하세요.',
        usb2: '가상 디스크가 마운트되었는지 확인하세요. (설정 - 가상 디스크).',
        usb3: '컴퓨터에서 가상 디스크를 열고 이미지 파일을 가상 디스크의 루트 디렉토리로 복사하세요.',
        scp1: 'CEC KVM과 컴퓨터가 동일한 로컬 네트워크에 있는지 확인하세요.',
        scp2: '컴퓨터에서 터미널을 열고 SCP 명령을 사용하여 이미지 파일을 CEC KVM의 /data 디렉터리에 업로드하세요.',
        scp3: '예시: scp [이미지 파일 경로] root@[CEC KVM IP 주소]:/data',
        tfCard: 'TF 카드',
        tf1: '이 방법은 Linux 시스템에서 지원됩니다',
        tf2: 'CEC KVM에서 TF 카드를 가져옵니다(전체 버전의 경우 먼저 케이스를 분해하세요).',
        tf3: 'TF 카드를 카드 리더기에 삽입하고 컴퓨터에 연결하세요.',
        tf4: '이미지 파일을 TF 카드의 /data 디렉터리에 복사하세요.',
        tf5: 'TF 카드를 CEC KVM에 삽입하세요.'
      }
    },
    script: {
      title: '스크립트',
    ...
    settings: {
      ...
      about: {
        ...
        mdns: 'mDNS',
        application: '펌웨어 버전',
        applicationTip: 'CEC KVM 웹 애플리케이션 버전',
        image: '이미지 버전',
        imageTip: 'CEC KVM 시스템 이미지 버전',
        deviceKey: '장치 키',
        community: '커뮤니티',
        hostname: '호스트 이름',
      ...
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'CEC KVM의 DNS 서버 설정',
          mode: '모드',
          dhcp: 'DHCP',
          manual: '수동',
          add: 'DNS 추가',
      ...
      tailscale: {
        ...
        package: '패키지 설치',
        unzip: '압축 해제',
        upTailscale: 'tailscale을 CEC KVM의 /usr/bin/ 경로에 업로드 했습니다.',
        upTailscaled: 'tailscaled을 CEC KVM의 /usr/sbin/ 경로에 업로드 했습니다.',
        refresh: '현재 페이지 새로고침',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmTitle: '원격 제어',
        kvmDescription: 'CEC KVM을 통한 원격 호스트 제어.',
