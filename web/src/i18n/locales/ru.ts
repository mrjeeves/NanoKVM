const ru = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Чтобы сбросить пароли, нажмите и удерживайте кнопку BOOT на CEC KVM в течении 10 секунд.',
        ...
        change4: 'Чтобы сбросить пароли, нажмите и удерживайте кнопку BOOT на CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Настройка Wi-Fi для CEC KVM',
      success: 'Пожалуйста, проверьте сетевой статус CEC KVM и откройте в браузере новый IP адрес.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Если мышь и клавиатура перестали отвечать, и перезагрузка HID-подсистемы не помогает, это может быть связано с несовместимостью между CEC KVM и устройством. Попробуйте включить режим только HID для улучшения совместимости.',
        ...
        tip3: 'CEC KVM автоматически перезагрузится после переключения режима',
    ...
    image: {
      ...
      tips: {
        title: 'Как загрузить',
        usb1: 'Подключите CEC KVM к вашему компьютеру через USB.',
        ...
        scp1: 'Убедитесь что CEC KVM и ваш компьютер находятся в одной и той же сети.',
        scp2: 'Откройте терминал на вашем компьютере и используйте команду scp, чтобы загрузить файл образа в директорию /data, находящуюся на CEC KVM.',
        scp3: 'Например: scp путь-к-образу root@ip-вашего-nanokvm:/data',
        tfCard: 'Карта памяти',
        tf1: 'Этот метод поддерживается на Linux-системах',
        tf2: 'Извлеките карту памяти из CEC KVM (если у вас "полная" (Full) версия, сначала нужно разобрать корпус).',
        ...
        tf5: 'Вставьте карту памяти в CEC KVM.'
      }
    },
    script: {
      title: 'Скрипты',
    ...
    settings: {
      title: 'Настройки',
      about: {
        title: 'О системе CEC KVM',
        information: 'Информация',
        ip: 'IP-адрес',
        mdns: 'Доменное имя mDNS',
        application: 'Версия ПО',
        applicationTip: 'Версия веб-программы CEC KVM',
        image: 'Версия прошивки',
        imageTip: 'Версия системного образа CEC KVM',
        deviceKey: 'Ключ устройства',
        community: 'Сообщество',
        hostname: 'Имя хоста',
        hostnameUpdated:
          'Имя хоста изменено. Перезагрузите CEC KVM, чтобы настройки вступили в силу.',
        ipType: {
          Wired: 'Проводное',
      ...
      device: {
        ...
        reboot: 'Перезагрузка',
        rebootDesc: 'Вы уверены, что хотите перезагрузить CEC KVM?',
        okBtn: 'Да',
        cancelBtn: 'Нет'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Настройка DNS-серверов для CEC KVM',
          mode: 'Режим',
          dhcp: 'DHCP',
          manual: 'Вручную',
          add: 'Добавить DNS',
      ...
      tailscale: {
        ...
        upTailscale: 'Переместите tailscale в каталог /usr/bin/ на CEC KVM',
        upTailscaled: 'Переместите tailscaled в каталог /usr/sbin/ на CEC KVM',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Управляйте удаленным хостом через CEC KVM.',
