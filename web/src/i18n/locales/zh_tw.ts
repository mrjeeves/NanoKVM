const zh_tw = {
  translation: {
    ...
    auth: {
      ...
      loginButtonText: '登入',
      tips: {
        reset1: '長按 CEC KVM 上的 BOOT 按鍵 10 秒鐘來重設帳號。',
        reset2: '詳細操作方法可參閱本文件：',
        reset3: '網頁預設帳號：',
        reset4: 'SSH 預設帳號：',
        ...
        change4: '如果您忘記密碼，需要長按 CEC KVM 上的 BOOT 按鍵來重設密碼。'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: '設定 CEC KVM Wi-Fi',
      success: '請檢查 CEC KVM 的網路狀態，並存取新的 IP 位址。',
      failed: '操作失敗，請重試。',
    ...
    mouse: {
      ...
      hidOnly: {
        title: 'HID-Only 模式',
        desc: '如果您的滑鼠和鍵盤沒有反應，且重設 HID 無效，可能是 CEC KVM 與您的裝置間有相容性問題。請嘗試啟用 HID-Only 模式以獲得更好的相容性。',
        tip1: '啟用 HID-Only 模式將會停用虛擬隨身碟和虛擬網卡的功能',
        tip2: '在 HID-Only 模式下，映像檔掛載功能將被停用',
        tip3: 'CEC KVM 將在切換模式後自動重新啟動',
    ...
    image: {
      ...
      tips: {
        title: '如何上傳',
        usb1: '透過 USB 將 CEC KVM 連接到您的電腦。',
        usb2: '確保已安裝虛擬磁碟（設定 - 虛擬磁碟）。',
        usb3: '開啟電腦上的虛擬磁碟，將映象檔案複製到虛擬磁碟的根目錄下。',
        scp1: '確保 CEC KVM 和您的電腦位於同一區域網路。',
        scp2: '開啟電腦上的終端機，使用 SCP 指令將映像檔案上傳到 CEC KVM 的 /data 目錄下。',
        scp3: '範例：scp your-image-path root@your-nanokvm-ip:/data',
        tfCard: 'microSD 卡',
        tf1: '此方法適用於 Linux 系統',
        tf2: '從 CEC KVM 拔出 microSD 卡（FULL 版本請先拆開外殼）。',
        tf3: '使用 USB 讀卡機將 microSD 卡連接至電腦。',
        tf4: '將映像檔複製到 microSD 卡的 /data 目錄下。',
        tf5: '將 microSD 卡重新插回 CEC KVM。'
      }
    },
    script: {
      title: '指令碼',
    ...
    settings: {
      ...
      about: {
        ...
        mdns: 'mDNS',
        application: '應用程式版本',
        applicationTip: 'CEC KVM 網頁程式版本',
        image: '韌體版本',
        imageTip: 'CEC KVM 系统韌體版本',
        deviceKey: '設備序號',
        community: '社群',
        hostname: '主機名稱',
      ...
      device: {
        ...
        autostart: {
          title: '啟動時指令碼設定',
          description: '管理能夠在 CEC KVM 啟動時自動執行的相關指令碼',
          new: '建立新指令碼',
      ...
      network: {
        ...
        dns: {
          title: 'DNS',
          description: '設定 CEC KVM 使用的 DNS 伺服器',
          mode: '模式',
          dhcp: 'DHCP',
          manual: '手動',
          add: '新增 DNS',
      ...
      tailscale: {
        ...
        package: '安裝包',
        unzip: '並解壓縮它',
        upTailscale: '將 Tailscale 上傳到 CEC KVM 的 /usr/bin/ 資料夾',
        upTailscaled: '將 Tailscale 上傳到 CEC KVM 的 /usr/sbin/ 資料夾',
        refresh: '重新整理頁面',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmTitle: '遠端控制',
        kvmDescription: '透過 CEC KVM 操作遠端主機。',
        switched: '代理角色已切換',
