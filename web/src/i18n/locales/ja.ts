const ja = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1: 'パスワードをリセットするには、CEC KVM の BOOT ボタンを 10 秒間押し続けます。',
        ...
        change4:
          'パスワードを忘れた場合は、CEC KVM の BOOT ボタンを長押ししてパスワードをリセットする必要があります。'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'CEC KVM の Wi-Fi を設定する',
      success: 'CEC KVM のネットワークステータスを確認するにはデバイスにアクセスしてください。',
    ...
    mouse: {
      ...
      hidOnly: {
        title: 'HID-Only モード',
        desc: '使用中にマウスとキーボードが反応しなくなり、HID をリセットしても効果がない場合は、CEC KVM とデバイス間の互換性に問題がある可能性があります。互換性を向上させるために、HID-Only モードを有効にすることをお勧めします。',
        tip1: 'HID-Only モードを有効にすると、仮想 U ディスクと仮想ネットワークがアンマウントされます',
        tip2: 'HID-Only モードでは、イメージのマウントは無効になります',
        tip3: 'モードを切り替えると、CEC KVM は自動的に再起動します。',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'CEC KVM ウェブアプリケーションバージョン',
        image: 'イメージバージョン',
        imageTip: 'CEC KVM システムイメージバージョン',
        deviceKey: 'デバイスキー',
        community: 'コミュニティ',
        hostname: 'ホスト名',
      ...
      device: {
        ...
        autostart: {
          title: '自動起動スクリプト設定',
          description: 'CEC KVM の起動時に自動的に実行されるスクリプトファイルを管理します',
          new: '新しいスクリプトを作成する',
        ...
        reboot: '再起動',
        rebootDesc: 'CEC KVM を再起動してもよろしいですか?',
        okBtn: 'はい',
        cancelBtn: 'いいえ'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'CEC KVM の DNS サーバーを設定',
          mode: 'モード',
          dhcp: 'DHCP',
          manual: '手動',
          add: 'DNS を追加',
      ...
      tailscale: {
        ...
        unzip: '解凍してください',
        upTailscale: 'tailscale ファイルを CEC KVM の /usr/bin ディレクトリにアップロードします',
        upTailscaled: 'tailscaled ファイルを CEC KVM の /usr/sbin ディレクトリにアップロードします',
        refresh: 'ページを更新します',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmTitle: 'リモート操作',
        kvmDescription: 'CEC KVM を通じてリモート ホストを操作します。',
