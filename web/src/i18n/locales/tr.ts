const tr = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Şifreleri sıfırlamak için CEC KVM üzerinde bulunan BOOT tuşuna 10 saniye boyunca basılı tutun.',
    ...
    wifi: {
      title: 'Wi-Fi',
      description: 'CEC KVM için Wi-Fi ayarlarını ayarlayın',
      success: "CEC KVM'in bağlantı durumunu kontrol edin ve yeni IP adresini ziyaret edin.",
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Fare ve klavye yanıt vermeyi durdurursa ve HID sıfırlama yardımcı olmazsa, CEC KVM ile cihaz arasında bir uyumluluk sorunu olabilir. Daha iyi uyumluluk için yalnızca HID modunu etkinleştirmeyi deneyin.',
        ...
        tip3: 'CEC KVM mod değişiminden sonra kendiliğinden yeniden başlatılacaktır',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: "CEC KVM'i bilgisayarınıza USB ile bağlayın.",
        ...
        scp1: 'CEC KVM ve bilgisayarınızın aynı yerel ağda bulunduğundan emin olun.',
        scp2: "Bilgisayarınızda uçbirimi açın ve disk imajı dosyanını SCP komudunu kullanarak CEC KVM'in /data dizinine yükleyin.",
        ...
        tf2: "CEC KVM'den micro SD kartı çıkartın(TAM sürüm için öncelikle kutuyu sökün).",
        ...
        tf5: "micro SD kartı CEC KVM'e geri yerleştirin."
      }
    },
    script: {
      title: 'Betikler',
    ...
    settings: {
      title: 'Ayarlar',
      about: {
        title: 'CEC KVM Hakkında',
        information: 'Bilgi',
        ip: 'IP',
        mdns: 'mDNS',
        application: 'Uygulama sürümü',
        applicationTip: 'CEC KVM web uygulaması sürümü',
        image: 'İmaj Sürümü',
        imageTip: 'CEC KVM sistem imajı sürümü',
      ...
      device: {
        ...
        rebootDesc: "CEC KVM'i yeniden başlatmak istediğinizden emin misiniz?",
        okBtn: 'Evet',
        cancelBtn: 'Hayır'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'CEC KVM için DNS sunucularını yapılandır',
          mode: 'Mod',
          dhcp: 'DHCP',
          manual: 'Manuel',
          add: 'DNS ekle',
      ...
      tailscale: {
        ...
        upTailscale: "tailscale dosyasını CEC KVM'in /usr/bin dizinine yükleyin",
        upTailscaled: "tailscaled dosyasını CEC KVM'in /usr/sbin dizinine yükleyin",
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Uzak ana bilgisayarı CEC KVM aracılığıyla çalıştırın.',
