  ...
  translation: {
    ...
    auth: {
      ...
      tips: {
        ...
        change4: 'Untuk mengatur ulang kata sandi, tekan dan tahan tombol BOOT pada CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Konfigurasi Wi-Fi untuk CEC KVM',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Jika mouse dan keyboard Anda berhenti merespons dan menyetel ulang HID tidak membantu, mungkin ada masalah kompatibilitas antara CEC KVM dan perangkat. Coba aktifkan mode HID-Only untuk kompatibilitas yang lebih baik.',
        ...
        tip3: 'CEC KVM akan otomatis reboot setelah berpindah mode',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Hubungkan CEC KVM ke komputer Anda melalui USB.',
        ...
        scp1: 'Pastikan CEC KVM dan komputer Anda berada di jaringan lokal yang sama.',
        scp2: 'Buka terminal di komputer Anda dan gunakan perintah SCP untuk mengunggah file gambar ke direktori /data di CEC KVM.',
        scp3: 'Contoh: scp jalur-gambar-anda root@ip-nanokvm-anda:/data',
        tfCard: 'Kartu TF',
        tf1: 'Metode ini didukung di sistem linux',
        tf2: 'Dapatkan Kartu TF dari CEC KVM (untuk versi LENGKAP, bongkar casingnya terlebih dahulu).',
        ...
        tf5: 'Masukkan Kartu TF ke dalam CEC KVM.'
      }
    },
    script: {
      title: 'Script',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Versi aplikasi web CEC KVM',
        image: 'Version Gambar',
        imageTip: 'Versi image sistem CEC KVM',
      ...
      device: {
        ...
        reboot: 'Mulai ulang',
        rebootDesc: 'Apakah Anda yakin ingin me-reboot CEC KVM?',
        okBtn: 'Ya',
        cancelBtn: 'Tidak'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Konfigurasi server DNS untuk CEC KVM',
          mode: 'Mode',
          dhcp: 'DHCP',
          manual: 'Manual',
          add: 'Tambah DNS',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Operasikan host jarak jauh melalui CEC KVM.',
