const nl = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Om de wachtwoorden opnieuw in te stellen, houdt u de BOOT-knop op de CEC KVM 10 seconden lang ingedrukt.',
        ...
        change4:
          'Om de wachtwoorden opnieuw in te stellen, houdt u de BOOT-knop op de CEC KVM ingedrukt.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Wi-Fi configureren voor CEC KVM',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Als uw muis en toetsenbord niet meer reageren en het opnieuw instellen van HID niet helpt, kan er sprake zijn van een compatibiliteitsprobleem tussen de CEC KVM en het apparaat. Probeer de modus HID-Only in te schakelen voor betere compatibiliteit.',
        ...
        tip3: 'CEC KVM wordt automatisch opnieuw opgestart na het wisselen van modus',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Verbind de CEC KVM met uw computer via USB.',
        ...
        scp1: 'Zorg ervoor dat de CEC KVM en uw computer zich in hetzelfde lokale netwerk bevinden.',
        scp2: 'Open een terminal op uw computer en gebruik het SCP-commando om het imagebestand te uploaden naar de /data directory op de CEC KVM.',
        scp3: 'Voorbeeld: scp uw-image-pad root@uw-nanokvm-ip:/data',
        tfCard: 'TF-kaart',
        tf1: 'Deze methode wordt ondersteund op Linux-systemen',
        tf2: 'Haal de TF-kaart uit de CEC KVM (voor de VOLLEDIGE versie, demonteer eerst de behuizing).',
        ...
        tf5: 'Plaats de TF-kaart terug in de CEC KVM.'
      }
    },
    script: {
      title: 'Script',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Versie van de CEC KVM-webapplicatie',
        image: 'Image versie',
        imageTip: 'Versie van de CEC KVM-systeemimage',
      ...
      device: {
        ...
        rebootDesc: 'Weet u zeker dat u CEC KVM opnieuw wilt opstarten?',
        okBtn: 'Ja',
        cancelBtn: 'Nee'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Configureer DNS-servers voor CEC KVM',
          mode: 'Modus',
          dhcp: 'DHCP',
          manual: 'Handmatig',
          add: 'DNS toevoegen',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Bedien de externe host via CEC KVM.',
