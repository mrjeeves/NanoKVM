  ...
  translation: {
    ...
    auth: {
      ...
      tips: {
        ...
        change4: 'For å tilbakestille passordene holder du BOOT-knappen på CEC KVM inne.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
    ...
    mouse: {
      ...
      hidOnly: {
        title: 'Kun HID-modus',
        desc: 'Hvis musen og tastaturet slutter å svare og tilbakestilling av HID ikke hjelper, kan det være et kompatibilitetsproblem mellom CEC KVM og enheten. Prøv å aktivere HID-Only-modus for bedre kompatibilitet.',
        ...
        tip3: 'CEC KVM vil automatisk starte på nytt etter bytte av modus',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Koble til CEC KVM-enheten til din datamaskin med USB.',
        ...
        scp1: 'Sikre at CEC KVM-enheten og datamaskinen din er tilkoblet det samme lokale nettverket.',
        scp2: 'Åpne en terminal på datamaskinen din og bruk SCP-kommandoen til å laste opp arkivfilen til mappen /data på CEC KVM-enheten.',
        scp3: 'Eksempel: scp sti-til-din-arkivfil root@din-nanokvm-ip:/data',
        tfCard: 'TF-kort',
        tf1: 'Denne metoden er støttet på datamskiner med Linux',
        tf2: 'Ta TF-kortet ut av CEC KVM-enheten (hvis du har FULL-versjonen, demonter kabinettet først).',
        ...
        tf5: 'Sett inn TF-kortet i CEC KVM-enheten.'
      }
    },
    script: {
      title: 'Skript',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Versjon av CEC KVM-webapplikasjonen',
        image: 'Arkivfil-versjon',
        imageTip: 'Versjon av CEC KVM-systemavbildningen',
      ...
      device: {
        ...
        rebootDesc: 'Er du sikker på at du vil starte CEC KVM på nytt?',
        okBtn: 'Ja',
        cancelBtn: 'Nei'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Konfigurer DNS-servere for CEC KVM',
          mode: 'Modus',
          dhcp: 'DHCP',
          manual: 'Manuell',
          add: 'Legg til DNS',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Betjen den eksterne verten gjennom CEC KVM.',
