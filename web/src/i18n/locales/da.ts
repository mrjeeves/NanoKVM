  ...
  translation: {
    ...
    auth: {
      ...
      tips: {
        ...
        change4: 'For at nulstille adgangskoderne skal du holde BOOT-knappen på CEC KVM nede.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Konfigurer Wi-Fi for CEC KVM',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Hvis din mus og tastatur holder op med at reagere, og nulstilling af HID ikke hjælper, kan det være et kompatibilitetsproblem mellem CEC KVM og enheden. Prøv at aktivere HID-Only-tilstand for bedre kompatibilitet.',
        ...
        tip3: 'CEC KVM genstarter automatisk efter at have skiftet tilstand',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Forbind din CEC KVM til din computer via USB.',
        ...
        scp1: 'Kontroller at din CEC KVM og din computer er på samme lokale netværk.',
        scp2: 'Åben en terminal på din computer og brug SCP-kommandoen for at uploade diskbilledet til /data mappen på din CEC KVM.',
        scp3: 'Eksempel: scp sti-til-dit-diskbillede root@din-nanokvm-ip:/data',
        tfCard: 'microSD-kort',
        tf1: 'Denne metode er understøttet af Linux systemer',
        tf2: 'Tag microSD-kortet ud af din CEC KVM (for den fulde version af CEC KVM skal du åbne enheden for at kunne tage microSD-kortet ud).',
        ...
        tf5: 'Skub microSD-kortet ud og indsæt microSD-kortet i din CEC KVM.'
      }
    },
    script: {
      title: 'Script',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Version af CEC KVM-webapplikationen',
        image: 'Firmware version',
        imageTip: 'Version af CEC KVM-systemimaget',
      ...
      device: {
        ...
        reboot: 'Genstart',
        rebootDesc: 'Er du sikker på, at du vil genstarte CEC KVM?',
        okBtn: 'Ja',
        cancelBtn: 'Annuller'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Konfigurer DNS-servere til CEC KVM',
          mode: 'Tilstand',
          dhcp: 'DHCP',
          manual: 'Manuel',
          add: 'Tilføj DNS',
      ...
      tailscale: {
        ...
        unzip: 'og udpak den',
        upTailscale: 'Upload tailscale til CEC KVM-mappen /usr/bin/',
        upTailscaled: 'Upload tailscaled til CEC KVM-mappen /usr/sbin/',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Betjen fjernværten gennem CEC KVM.',
