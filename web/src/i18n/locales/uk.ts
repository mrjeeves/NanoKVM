const uk = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Щоб скинути паролі, натисніть і утримуйте кнопку BOOT на AllMyKVM протягом 10 секунд.',
        ...
        change4: 'Щоб скинути паролі, натисніть і утримуйте кнопку BOOT на AllMyKVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Налаштування Wi-Fi для AllMyKVM',
      success: 'Перейдіть до пристрою та перевірте стан мережі AllMyKVM.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        tip3: 'AllMyKVM автоматично перезавантажиться після перемикання режимів',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: "Під'єднайте AllMyKVM до вашого комп'ютера через USB.",
        ...
        scp1: "Переконайтеся, що AllMyKVM і ваш комп'ютер знаходяться в одній локальній мережі.",
        scp2: "Відкрийте термінал на вашому комп'ютері та використовуйте команду SCP для завантаження файлу зображення до каталогу /data на AllMyKVM.",
        scp3: 'Приклад: scp ваш-шлях-до-зображення root@ваш-ip-nanokvm:/data',
        tfCard: 'TF карта',
        tf1: 'Цей метод підтримується на системах Linux',
        tf2: 'Отримайте TF карту з AllMyKVM (для повної версії, спочатку розберіть корпус).',
        ...
        tf5: 'Вставте TF карту в AllMyKVM.'
      }
    },
    script: {
      title: 'Скрипти',
    ...
    settings: {
      ...
      device: {
        ...
        rebootDesc: 'Ви впевнені, що хочете перезавантажити AllMyKVM?',
        okBtn: 'Так',
        cancelBtn: 'Ні'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Налаштування DNS-серверів для AllMyKVM',
          mode: 'Режим',
          dhcp: 'DHCP',
          manual: 'Вручну',
          add: 'Додати DNS',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Керуйте віддаленим хостом через AllMyKVM.',
