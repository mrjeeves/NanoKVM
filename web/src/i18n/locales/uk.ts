const uk = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Щоб скинути паролі, натисніть і утримуйте кнопку BOOT на CEC KVM протягом 10 секунд.',
        ...
        change4: 'Щоб скинути паролі, натисніть і утримуйте кнопку BOOT на CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Налаштування Wi-Fi для CEC KVM',
      success: 'Перейдіть до пристрою та перевірте стан мережі CEC KVM.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Якщо ваша миша та клавіатура перестають відповідати та скинути HID, це не допомагає, це може бути проблемою сумісності між CEC KVM та пристроєм. Спробуйте ввімкнути режим "лише HID" лише для кращої сумісності.',
        ...
        tip3: 'CEC KVM автоматично перезавантажиться після перемикання режимів',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: "Під'єднайте CEC KVM до вашого комп'ютера через USB.",
        ...
        scp1: "Переконайтеся, що CEC KVM і ваш комп'ютер знаходяться в одній локальній мережі.",
        scp2: "Відкрийте термінал на вашому комп'ютері та використовуйте команду SCP для завантаження файлу зображення до каталогу /data на CEC KVM.",
        scp3: 'Приклад: scp ваш-шлях-до-зображення root@ваш-ip-nanokvm:/data',
        tfCard: 'TF карта',
        tf1: 'Цей метод підтримується на системах Linux',
        tf2: 'Отримайте TF карту з CEC KVM (для повної версії, спочатку розберіть корпус).',
        ...
        tf5: 'Вставте TF карту в CEC KVM.'
      }
    },
    script: {
      title: 'Скрипти',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Версія веб-додатка CEC KVM',
        image: 'Версія образу',
        imageTip: 'Версія системного образу CEC KVM',
      ...
      device: {
        ...
        rebootDesc: 'Ви впевнені, що хочете перезавантажити CEC KVM?',
        okBtn: 'Так',
        cancelBtn: 'Ні'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Налаштування DNS-серверів для CEC KVM',
          mode: 'Режим',
          dhcp: 'DHCP',
          manual: 'Вручну',
          add: 'Додати DNS',
      ...
      tailscale: {
        ...
        upTailscale: 'Завантажте Tailscale до каталогу /usr/bin/ на CEC KVM',
        upTailscaled: 'Завантажте Tailscaled до каталогу /usr/sbin/ на CEC KVM',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Керуйте віддаленим хостом через CEC KVM.',
