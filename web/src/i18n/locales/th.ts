const th = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1: 'หากต้องการรีเซ็ตรหัสผ่าน ให้กดปุ่ม BOOT บน CEC KVM ค้างไว้ 10 วินาที',
        ...
        change4: 'เพื่อรีเช็ทรหัสผ่าน, กรุณากดปุ่ม BOOT บนอุปกรณ์ CEC KVM ค้างไว้.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'ตั้งค้า Wi-Fi สำหรับ CEC KVM',
      success: 'กรุณาตรวจสอบสถานะเครื่องข่ายของ CEC KVM และไปที่ IP address ใหม่',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'หากเมาส์และคีย์บอร์ดของคุณหยุดตอบสนองและการรีเซ็ต HID ไม่ช่วย อาจเป็นปัญหาความเข้ากันได้ระหว่าง CEC KVM และอุปกรณ์ ลองเปิดโหมด HID-Only เพื่อความเข้ากันได้ที่ดีขึ้น',
        tip1: 'การเปิดโหมด HID-Only จะปิดการทำงานดิสก์จำลองและ NIC จำลอง',
        tip2: 'ในโหมด HID-Only ดิสก์จะลองจะถูกปิดใช้งาน',
        tip3: 'CEC KVM จะรีบูตอัตโนมัติหลังจากเปลี่ยนโหมด',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'เชื่อมต่อ CEC KVM กับคอมพิวเตอร์ของคุณผ่าน USB',
        ...
        scp1: 'ตรวจสอบให้แน่ใจว่า CEC KVM และคอมพิวเตอร์ของคุณอยู่ในเครือข่ายเดียวกัน',
        scp2: 'เปิดเทอร์มินัลบนคอมพิวเตอร์ของคุณและใช้คำสั่ง SCP เพื่ออัปโหลดไฟล์อิมเมจไปยังไดเรกทอรี /data บน CEC KVM',
        scp3: 'ตัวอย่าง: scp <ที่อยู่ของไฟล์> root@<ip อุปกรณ์>:/data',
        tfCard: 'การ์ด TF',
        tf1: 'วิธีนี้รองรับแค่บนระบบปฏิบัติการ Linux',
        tf2: 'นำการ์ด TF ออกจาก CEC KVM',
        tf3: 'ใส่การ์ด TF ลงในเครื่องอ่านการ์ดและเชื่อมต่อกับคอมพิวเตอร์ของคุณ',
        tf4: 'คัดลอกไฟล์อิมเมจไปยังไดเรกทอรี /data บนการ์ด TF',
        tf5: 'ใส่การ์ด TF กลับเข้า CEC KVM'
      }
    },
    script: {
      title: 'สคริปต์',
    ...
    settings: {
      title: 'การตั้งค่า',
      about: {
        title: 'เกี๋ยวกับ CEC KVM',
        information: 'ข้อมูล',
        ip: 'IP',
        mdns: 'mDNS',
        application: 'เวอร์ชั่นแอปพิเคชั่น',
        applicationTip: 'เวอร์ชั่นเว็บ CEC KVM',
        image: 'เวอร์ชั่น Image ระบบ',
        imageTip: 'เวอร์ชั่น Image ระบบ CEC KVM',
      ...
      device: {
        ...
        reboot: 'รีบูต',
        rebootDesc: 'คุณแน่ใจหรือไม่ว่าต้องการรีบูต CEC KVM',
        okBtn: 'ใช่',
        cancelBtn: 'ไม่ใช่'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'ตั้งค่าเซิร์ฟเวอร์ DNS สำหรับ CEC KVM',
          mode: 'โหมด',
          dhcp: 'DHCP',
          manual: 'กำหนดเอง',
          add: 'เพิ่ม DNS',
      ...
      tailscale: {
        ...
        unzip: 'และแตกไฟล์',
        upTailscale: 'อัปโหลด tailscale ไปยังไดเรกทอรี /usr/bin/ ของ CEC KVM',
        upTailscaled: 'อัปโหลด tailscaled ไปยังไดเรกทอรี /usr/sbin/ ของ CEC KVM',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'ใช้งานโฮสต์ระยะไกลผ่าน CEC KVM',
