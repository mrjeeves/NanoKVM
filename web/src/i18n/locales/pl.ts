  ...
  translation: {
    ...
    auth: {
      ...
      tips: {
        ...
        change4: 'Aby zresetować hasła, naciśnij i przytrzymaj przycisk BOOT na CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Skonfiguruj Wi-Fi dla CEC KVM',
      success: 'Proszę podejść do urządzenia, aby sprawdzić stan sieci CEC KVM.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Jeśli mysz i klawiatura przestaną odpowiadać, a resetowanie HID nie pomoże, może to oznaczać problem ze zgodnością między CEC KVM a urządzeniem. Spróbuj włączyć tryb HID-Only, aby uzyskać lepszą kompatybilność.',
        ...
        tip3: 'CEC KVM automatycznie uruchomi się ponownie po przełączeniu trybów',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Podłącz urządzenie CEC KVM do komputera przez USB.',
        ...
        scp1: 'Upewnij się że CEC KVM i twój komputer są na tej samej sieci lokalnej.',
        scp2: 'Otwórz terminal na komputerze i użyj komendę SCP aby przesłać obraz do katalogu /data na CEC KVM.',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Wersja aplikacji web CEC KVM',
        image: 'Wersja obrazu',
        imageTip: 'Wersja obrazu systemu CEC KVM',
      ...
      device: {
        ...
        rebootDesc: 'Czy na pewno chcesz ponownie uruchomić CEC KVM?',
        okBtn: 'Tak',
        cancelBtn: 'Nie'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Skonfiguruj serwery DNS dla CEC KVM',
          mode: 'Tryb',
          dhcp: 'DHCP',
          manual: 'Ręcznie',
          add: 'Dodaj DNS',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Sterowanie zdalnym hostem poprzez CEC KVM.',
