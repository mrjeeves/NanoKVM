const de = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Um das Passwort zurückzusetzen, drücken und halten Sie den BOOT Knopf auf dem CEC KVM für 10 Sekunden.',
        ...
        change4:
          'Um die Passwörter zurückzusetzen, drücken und halten Sie den BOOT Knopf auf dem CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Wi-Fi Konfiguration für CEC KVM',
      success:
        'Bitte überprüfen Sie den Netzwerk-Status des CEC KVM und greifen Sie über die neue IP Adresse darauf zu.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Wenn Ihre Maus und Tastatur nicht mehr reagieren und das Zurücksetzen der HID-Verbindung nicht hilft, könnte es sich um ein Kompatibilitätsproblem zwischen dem CEC KVM und dem Gerät handeln. Versuchen Sie, den HID-Only Modus zu aktivieren, um die Kompatibilität zu verbessern.',
        ...
        tip3: 'CEC KVM wird nach dem Wechsel in den neuen Modus automatisch neu gestartet.',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: 'Verbinden Sie den CEC KVM über USB mit Ihrem Computer.',
        ...
        scp1: 'Stellen Sie sicher, dass sich der CEC KVM und Ihr Computer im selben lokalen Netzwerk befinden.',
        scp2: 'Öffnen Sie ein Terminal auf Ihrem Computer und verwenden Sie den SCP-Befehl, um die Image-Datei in das Verzeichnis /data auf dem CEC KVM hochzuladen.',
        scp3: 'Beispiel: scp your-image-path root@your-nanokvm-ip:/data',
        tfCard: 'TF-Karte',
        tf1: 'Diese Methode wird unter Linux-Systemen unterstützt.',
        tf2: 'Entnehmen Sie die TF-Karte aus dem CEC KVM (bei der FULL-Version muss zuvor das Gehäuse geöffnet werden).',
        ...
        tf5: 'Setzen Sie die TF-Karte wieder in den CEC KVM ein.'
      }
    },
    script: {
      title: 'Skripte',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'CEC KVM Web Applikations-Version',
        image: 'Systemabbild-Version',
        imageTip: 'CEC KVM Systemabbild-Version',
      ...
      device: {
        ...
        reboot: 'Neustarten',
        rebootDesc: 'Sind Sie sicher dass Sie CEC KVM neustarten möchten?',
        okBtn: 'Ja',
        cancelBtn: 'Nein'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'DNS-Server für CEC KVM konfigurieren',
          mode: 'Modus',
          dhcp: 'DHCP',
          manual: 'Manuell',
          add: 'DNS hinzufügen',
      ...
      tailscale: {
        ...
        upTailscale: 'Tailscale nach /usr/bin/ auf CEC KVM hochladen',
        upTailscaled: 'Tailscaled nach /usr/bin/ auf CEC KVM hochladen',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Betreiben Sie den Remote-Host über CEC KVM.',
