  ...
  translation: {
    ...
    auth: {
      ...
      tips: {
        ...
        change4: 'Chcete-li hesla resetovat, podržte tlačítko BOOT na CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Nastavit Wi-Fi pro CEC KVM',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Pokud vaše myš a klávesnice přestanou reagovat a resetování HID nepomůže, může jít o problém s kompatibilitou mezi CEC KVM a zařízením. Zkuste povolit režim HID-Only pro lepší kompatibilitu.',
        tip1: 'Povolení režimu HID-Only odpojí virtuální U-disk a virtuální síť',
        tip2: 'V režimu HID-Only je připojení obrazu zakázáno',
        tip3: 'CEC KVM se po přepnutí režimů automaticky restartuje',
    ...
    image: {
      ...
      tips: {
        title: 'Jak nahrát',
        usb1: 'Připojte CEC KVM k vašemu počítači přes USB.',
        ...
        scp1: 'Ujistěte se, že jsou CEC KVM a váš počítač ve stejné místní síti.',
        scp2: 'Otevřete terminál na vašem počítači a použijte příkaz SCP pro nahrání souboru s obrazem do adresáře /data na zařízení CEC KVM.',
        scp3: 'Příklad: scp cesta-k-vašemu-obrazu root@ip-nanokvm:/data',
        tfCard: 'SD Karta',
        tf1: 'Tato metoda je podporována na systémech Linux',
        tf2: 'Vyjměte SD kartu z CEC KVM (u plné verze nejprve rozložte krabičku).',
        ...
        tf5: 'Vložte SD kartu zpět do CEC KVM.'
      }
    },
    script: {
      title: 'Skript',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Verze webové aplikace CEC KVM',
        image: 'Verze obrazu',
        imageTip: 'Verze systémového obrazu CEC KVM',
      ...
      device: {
        ...
        reboot: 'Restartujte',
        rebootDesc: 'Opravdu chcete restartovat CEC KVM?',
        okBtn: 'Ano',
        cancelBtn: 'Ne'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Nastavit DNS servery pro CEC KVM',
          mode: 'Režim',
          dhcp: 'DHCP',
          manual: 'Ručně',
          add: 'Přidat DNS',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Ovládejte vzdáleného hostitele prostřednictvím CEC KVM.',
