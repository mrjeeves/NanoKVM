const zh = {
  translation: {
    ...
    auth: {
      ...
      loginButtonText: '登录',
      tips: {
        reset1: '长按 CEC KVM 上的 BOOT 按键 10 秒钟来重置帐号。',
        reset2: '详细操作步骤可参考此文档：',
        reset3: '网页默认帐号：',
        reset4: 'SSH 默认帐号：',
        ...
        change4: '如果您忘记了密码，需要长按 CEC KVM 上的 BOOT 按键来重置密码。'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: '配置 CEC KVM Wi-Fi 信息',
      success: '请前往设备检查 CEC KVM 的网络状态。',
      failed: '操作失败，请重试。',
    ...
    mouse: {
      ...
      hidOnly: {
        title: 'HID-Only 模式',
        desc: '若使用过程中遇到鼠标键盘无响应，且重置 HID 无效，可能是 CEC KVM 与您的设备存在兼容性问题。建议尝试启用 HID-Only 模式以提升兼容性。',
        tip1: '启用 HID-Only 模式会卸载虚拟 U 盘和虚拟网络',
        tip2: 'HID-Only 模式下，镜像挂载将被禁用',
        tip3: '切换模式后将自动重启 CEC KVM',
    ...
    image: {
      ...
      tips: {
        title: '如何上传',
        usb1: '将 CEC KVM 通过 USB 连接到你的电脑；',
        usb2: '确保已经挂载了虚拟硬盘（设置 - 虚拟硬盘）；',
        usb3: '在电脑上打开虚拟硬盘，将镜像文件拷贝到虚拟硬盘的根目录下。',
        scp1: '确保 CEC KVM 和你的电脑在同一个局域网内；',
        scp2: '在电脑上打开终端软件，使用 SCP 命令将镜像文件上传到 CEC KVM 的 /data 目录。',
        scp3: '示例：scp your-image-path root@your-nanokvm-ip:/data',
        tfCard: 'TF 卡',
        tf1: '该方式适用于 Linux 系统',
        tf2: '将 TF 卡从 CEC KVM 中取出（FULL 版本需要先拆开外壳）；',
        tf3: '将 TF 卡插入读卡器并连接到你的电脑；',
        tf4: '从电脑上拷贝镜像文件到 TF 卡的 /data 目录下；',
        tf5: '将 TF 卡重新插入 CEC KVM。'
      }
    },
    script: {
      title: '脚本',
    ...
    settings: {
      ...
      about: {
        ...
        mdns: 'mDNS',
        application: '应用版本',
        applicationTip: 'CEC KVM 网页应用版本',
        image: '镜像版本',
        imageTip: 'CEC KVM 系统镜像版本',
        deviceKey: '设备码',
        community: '社区',
        hostname: '主机名',
      ...
      device: {
        ...
        autostart: {
          title: '自动启动脚本设置',
          description: '管理能够在 CEC KVM 启动时自动运行的脚本文件',
          new: '创建新脚本',
      ...
      network: {
        ...
        dns: {
          title: 'DNS',
          description: '配置 CEC KVM 使用的 DNS 服务器',
          mode: '模式',
          dhcp: 'DHCP',
          manual: '手动',
          add: '添加 DNS',
      ...
      mesh: {
        ...
        handRaise: '举手求助',
        handRaiseDesc:
          '在 CEC 支持队列中举手，让技术人员知道此设备需要帮助。轻按 BOOT 按键即可举手或放下（长按约 10 秒可重置账号）。',
        supportNumber: '支持编号',
        raiseHand: '举手',
        lowerHand: '放下',
      ...
      tailscale: {
        ...
        package: '安装包',
        unzip: '并解压',
        upTailscale: '将 tailscale 上传到 CEC KVM 的 /usr/bin/ 目录',
        upTailscaled: '将 tailscaled 上传到 CEC KVM 的 /usr/sbin/ 目录',
        refresh: '刷新页面',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmTitle: '远程控制',
        kvmDescription: '通过 CEC KVM 操作下游远程主机。',
        switched: '角色已切换',
        switchFailed: '切换角色失败'
      },
      send: '发送',
