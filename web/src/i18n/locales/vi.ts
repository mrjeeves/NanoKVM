  ...
  translation: {
    ...
    auth: {
      ...
      tips: {
        ...
        change4: 'Để đặt lại mật khẩu, hãy nhấn và giữ nút BOOT trên CEC KVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Cấu hình Wi-Fi cho CEC KVM',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Nếu chuột và bàn phím của bạn ngừng phản hồi và việc đặt lại HID không có tác dụng thì đó có thể là sự cố tương thích giữa CEC KVM và thiết bị. Hãy thử bật chế độ HID-Only để tương thích tốt hơn.',
        tip1: 'Kích hoạt HID-Chế độ chỉ sẽ ngắt kết nối đĩa U ảo và mạng ảo',
        tip2: 'Ở chế độ HID-Chỉ, tính năng gắn hình ảnh bị tắt',
        tip3: 'CEC KVM sẽ tự động khởi động lại sau khi chuyển chế độ',
    ...
    image: {
      ...
      tips: {
        title: 'Cách tải lên',
        usb1: 'Kết nối CEC KVM với máy tính của bạn qua USB.',
        ...
        scp1: 'Đảm bảo CEC KVM và máy tính của bạn đang trên cùng một mạng nội bộ.',
        scp2: 'Mở terminal trên máy tính và sử dụng lệnh SCP để tải đĩa ảo lên thư mục /data trên CEC KVM.',
        scp3: 'Ví dụ: scp đường-dẫn-image root@ip-của-nanokvm:/data',
        tfCard: 'Thẻ TF',
        tf1: 'Phương pháp này được hỗ trợ trên hệ thống Linux',
        tf2: 'Lấy thẻ TF từ CEC KVM (với phiên bản FULL, hãy tháo vỏ trước).',
        tf3: 'Chèn thẻ TF vào đầu đọc thẻ và kết nối với máy tính của bạn.',
        tf4: 'Sao chép tệp hình ảnh vào thư mục /data trên thẻ TF.',
        tf5: 'Chèn thẻ TF vào CEC KVM.'
      }
    },
    script: {
      title: 'Script',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Phiên bản ứng dụng web CEC KVM',
        image: 'Phiên bản Hình ảnh',
        imageTip: 'Phiên bản image hệ thống CEC KVM',
      ...
      device: {
        ...
        rebootDesc: 'Bạn có chắc chắn muốn khởi động lại CEC KVM không?',
        okBtn: 'Có',
        cancelBtn: 'Không'
      },
      network: {
        ...
        dns: {
          title: 'DNS',
          description: 'Cấu hình máy chủ DNS cho CEC KVM',
          mode: 'Chế độ',
          dhcp: 'DHCP',
          manual: 'Thủ công',
          add: 'Thêm DNS',
    ...
    picoclaw: {
      ...
      agent: {
        ...
        kvmDescription: 'Vận hành máy chủ từ xa thông qua CEC KVM.',
